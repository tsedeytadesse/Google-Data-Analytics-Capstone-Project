...
SELECT a1.member_casual,a1.day_of_week,a1.m202206,a2.m202207,a3.m202208, 
...
FROM (
  SELECT EXTRACT(DAYOFWEEK FROM started_at) AS day_of_week, member_casual, count(ride_id) AS m202206,
   ROUND(avg(timestamp_diff(ended_at, started_at, MINUTE)),1) as avg202206,
...
JOIN (
    SELECT EXTRACT(DAYOFWEEK FROM started_at) AS day_of_week, member_casual, count(ride_id) AS m202209, 
    ROUND(avg(timestamp_diff(ended_at, started_at, MINUTE)),1) as avg202209,
...
ON a3.member_casual = a4.member_casual AND a3.day_of_week = a4.day_of_week 

JOIN (
    SELECT EXTRACT(DAYOFWEEK FROM started_at) AS day_of_week, member_casual, count(ride_id) AS m202210, 
    ROUND(avg(timestamp_diff(ended_at, started_at, MINUTE)),1) as avg202210,
...
ON a4.member_casual = a5.member_casual AND a4.day_of_week = a5.day_of_week 
...
JOIN (
    SELECT EXTRACT(DAYOFWEEK FROM started_at) AS day_of_week, member_casual, count(ride_id) AS m202301, 
    ROUND(avg(timestamp_diff(ended_at, started_at, MINUTE)),1) as avg202301,
...
ON a7.member_casual = a8.member_casual AND a7.day_of_week = a8.day_of_week 

JOIN (
    SELECT EXTRACT(DAYOFWEEK FROM started_at) AS day_of_week, member_casual, count(ride_id) AS m202302, 
    ROUND(avg(timestamp_diff(ended_at, started_at, MINUTE)),1) as avg202302,
...
ON a8.member_casual = a9.member_casual AND a8.day_of_week = a9.day_of_week 
